#varibales con sus tipos de datos
cadena = "Hola mundo"
numero_entero = 10
...
print("\tVariable (cadena) es de tipo: " , type(cadena) , "\n" ,
      "\tVariable (numero_entero) es de tipo: ", type(numero_entero) , "\n" ,
      "\tVariable (numero_flotante) es de tipo: ", type(numero_flotante) , "\n",
...
COMENTARIO MULTILINEA MAYORMENTE USADO DENTRO DE FUNCIONES O CLASES.
